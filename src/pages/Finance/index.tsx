       ...
       <section className={styles.defiProducts}>
         <div className={styles.defiProduct}>
          <div className={styles.defiImage}>
            <img className="img-fluid" src={`${globalThis.config.PUBLIC_URL}/static/defi01.svg`} alt="logo"/>
          </div>
         ...
         <div className={styles.defiProduct}>
          <div className={styles.defiImage}>
            <img className="img-fluid" src={`${globalThis.config.PUBLIC_URL}/static/defi02.svg`} alt="logo"/>
          </div>
          ...
          <a href="/eth"><img className={styles.imgArrowLink} src={`${globalThis.config.PUBLIC_URL}/static/arrow-go.svg`} alt="defi-product"/></a>
         </div>
         <div className={styles.defiProduct}>
          <div className={styles.defiImage}>
            <img className="img-fluid" src={`${globalThis.config.PUBLIC_URL}/static/defi03.svg`} alt="defi-product"/>
          </div>
         ...
         <div className={styles.defiProduct}>
          <div className={styles.defiImage}>
            <img className="img-fluid" src={`${globalThis.config.PUBLIC_URL}/static/defi04.svg`} alt="defi-product"/>
          </div>
          ...
          <a target="blank" href="https://auctions.scrt.network/"><img className={styles.imgArrowLink} src={`${globalThis.config.PUBLIC_URL}/static/arrow-go.svg`} alt="defi-product"/></a>
         </div>
         <div className={styles.defiProduct}>
          <div className={styles.defiImage}>
            <img className="img-fluid" src={`${globalThis.config.PUBLIC_URL}/static/defi05.svg`} alt="logo"/>
          </div>
